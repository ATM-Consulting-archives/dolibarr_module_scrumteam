...
/**
 * \file    test/functional/ScrumTeamFunctionalTest.php
 * \ingroup scrumteam
 ...
 *
 * @package Testscrumteam
 */
class ScrumTeamFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modScrumTeam')->click();
		} else {
			// Disable the module
			$this->byHref('modScrumTeam')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/scrumteam/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('scrumteam/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/scrumteam/admin/about.php');
		$this->authenticate();
		return $this->assertContains('scrumteam/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('scrumteamwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modScrumTeam_ScrumTeamTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modScrumTeam_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
