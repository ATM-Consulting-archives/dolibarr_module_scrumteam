...
/**
 *	\file       scrumteam/scrumteamindex.php
 *	\ingroup    scrumteam
 *	\brief      Home page of scrumteam top menu
 */
...
$langs->loadLangs(array("scrumteam@scrumteam"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->scrumteam->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("ScrumTeamArea"));

print load_fiche_titre($langs->trans("ScrumTeamArea"), '', 'scrumteam.png@scrumteam');
...
// Draft MyObject
if (! empty($conf->scrumteam->enabled) && $user->rights->scrumteam->read)
{
	$langs->load("orders");
